package com.pubutech.blog.core.shiro;
...
import com.pubutech.blog.framework.holder.SpringContextHolder;
...
public class ShiroService {
    ...
    public Map<String, String> loadFilterChainDefinitions() {
        ...
        filterChainDefinitionMap.put("/account/dyanmicPwd", "anon");
        filterChainDefinitionMap.put("/websocket", "anon");
        filterChainDefinitionMap.put("/testwebsocket.html", "anon");
